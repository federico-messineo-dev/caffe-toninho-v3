...
import type { ProductSpecData } from "@/lib/adapters";

const defaultSpecs: ProductSpecData[] = [
  { label: "Origini Caffè", value: "12+" },
  { label: "Etichette Vino", value: "80+" },
  { label: "Tostatura", value: "Artigianale" },
  { label: "Dal", value: "1987" },
];
...
export function EditorialSection({ specs = defaultSpecs, videoSrc }: EditorialSectionProps) {
    ...
    <section>
      ...
      <div ref={videoRef} className="relative aspect-[16/9] w-full md:aspect-[21/9] overflow-hidden">
        <video
          ...
          src={videoSrc ?? "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/27eb7fb4-0105-4010-ac9e-0ac977a31b05_1-FZ89nvBAAsR3caRJbhYv7T2mjBofth.mp4"}
        />
      </div>

      {/* Specs Grid */}
      <div className="grid grid-cols-2 gap-4 border-t border-border md:grid-cols-4 md:gap-0">
        {specs.map((spec) => (
          <div
            key={spec.label}
