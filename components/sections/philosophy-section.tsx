    ...
    <section id="products">
              ...
              <div className="relative w-full" style={{ transformStyle: 'preserve-3d', minHeight: '150px' }}>
                {titles.map((title, index) => {
                  ...
                  return (
                    <h2 
                      key={index}
                      className="absolute inset-0 flex items-center justify-center text-[8vw] sm:text-[7vw] font-medium leading-tight tracking-tighter text-primary md:text-[6vw] lg:text-[5vw] text-center px-4"
                      style={{
      ...
      <div ref={descriptionRef} className="px-6 pt-8 pb-20 md:px-12 md:pt-12 md:pb-28 lg:px-20 lg:pt-16 lg:pb-36">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-primary font-semibold text-4xl text-center">
            {("Ogni tazza racconta una storia. Dai campi di coltivazione alle nostre mani, selezioniamo solo i migliori chicchi d'origine. Accanto al caffè, una cantina curata con gli stessi criteri di qualità — vini che raccontano territori e tradizioni.").split(" ").map((word, index, array) => {
