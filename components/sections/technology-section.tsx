...
const defaultTechImages: HeroImageData[] = [
  { src: "/images/interior-view.png", alt: "Laboratorio di torrefazione", position: "left", span: 1 },
  { src: "/images/rusted-metal.png", alt: "Atmosfera artigianale", position: "right", span: 1 },
];
...
export function TechnologySection({
  ...
  const descriptionText = description ?? "Torrefazione artigianale che rispetta la tradizione italiana del caffè. Selezione rigorosa di chicchi d'origine, tostatura lenta e meticolosa. Accanto al bar, una cantina con vini selezionati dai migliori produttori italiani e internazionali.";
  ...
  return (
    <section ref={sectionRef} className="relative bg-section-dark">
