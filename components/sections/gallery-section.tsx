...
import type { GalleryImageData } from "@/lib/adapters";

const defaultImages: GalleryImageData[] = [
  { src: "/images/gallery-1.jpg", alt: "Toninho Caffè — Tostatura artigianale" },
  { src: "/images/gallery-2.jpg", alt: "Toninho Caffè — Macinazione fresca" },
  { src: "/images/gallery-3.jpg", alt: "Toninho Caffè — Vini della cantina" },
  { src: "/images/gallery-4.jpg", alt: "Toninho Caffè — Atmosfera del bar" },
];
...
export function GallerySection({ images = defaultImages }: GallerySectionProps) {
