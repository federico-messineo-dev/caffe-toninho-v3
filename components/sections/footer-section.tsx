...
const footerLinks = {
  explore: [
    { label: "Torrefazione", href: "/collections/cafe" },
  ...
  about: [
    ...
    { label: "La Torrefazione", href: "#" },
    { label: "La Cantina", href: "#prodotti" },
    { label: "Contatti", href: "#contattaci" },
  ],
  service: [
    { label: "FAQ", href: "#" },
    { label: "Spedizioni", href: "#" },
    { label: "Prenotazioni", href: "#" },
    { label: "Privé", href: "#" },
  ],
};
        ...
        <div className="grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-muted-foreground">
              Bar, enoteca e torrefazione artigianale. Caffè specialty, vini selezionati e un'esperienza autentica dal 1987.
            </p>
          </div>
      ...
      <div className="border-t border-border px-6 py-6 md:px-12 lg:px-20">
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          <p className="text-xs text-muted-foreground">
            2026 FRED STUDIO. All rights reserved.
          </p>
